  ...
  try {
    ...
    const response = await fetch('https://api.elevenlabs.io/v1/convai/agents/create', {
      ...
      body: JSON.stringify({
        ...
        conversation_config: {
          agent: {
            first_message: "Hello! I'm Clarify, your AI tutor. I'm here to help you understand any diagrams or concepts from your textbook. Feel free to ask me any questions or highlight a diagram for me to explain!",
            prompt: {
